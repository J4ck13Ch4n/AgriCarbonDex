        ...
        <div style={{ background: '#111214', minHeight: '100vh' }}>
            ...
            <div style={{ maxWidth: '1600px', margin: '0 auto', padding: '24px 8px' }}>
                <div style={{ display: 'flex', gap: '24px', minHeight: '400px' }}>
                    <div style={{ flex: '1 1 25%', minWidth: 340, display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
                        <OrderForm data={[]} />
                    </div>
                    <div style={{ flex: '1 1 75%', minWidth: 800, display: 'flex', flexDirection: 'column', gap: 0 }}>
